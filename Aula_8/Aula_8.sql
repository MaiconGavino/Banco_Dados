...
select
	...
	count(distinct cd_funcionario) as qtd_funcionario
from funcionarios f 
...
select 
	nm_funcionario,
	-- (current_date - dt_nascimento)/360 as idade,
...
from funcionarios f 
left join telefone t on f.cd_funcionario = t.cd_funcionario and t.tp_telefone = 'comercial'
left join telefone t2 on f.cd_funcionario = t2.cd_funcionario and t2.tp_telefone = 'pessoal'
...
select 
	...
	email
from funcionarios
inner join ult_email on f.cd_funcionario and ordem = 1